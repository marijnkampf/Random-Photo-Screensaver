...
function getQueryStrings(a) {
	if (typeof(a) == "undefined" || a == "") a = window.location.search.substr(1).split('&');
	var b = {};
...
window.onload = function() {
	...
	initFilters();
	// Init preview with ?m=# monitors
	if (typeof(window.external.InvokeScriptOnMonitor)=== "undefined") {
		var params = getQueryStrings();
		if (typeof params["m"] == "undefined") params["m"] = 3;
		initMonitors(params["m"]);
		if (params["m"] > 1) {
			$("body").addClass("multi");
		}
	}
